...
import { CustomerExtraInformationDataVM } from "../customer-view-models";
import { ProductExtraInformationDataVM } from "../product-view-models";

export class ExtraInformationVM {
  ...
  public readonly productExtraInformationDatas: ProductExtraInformationDataVM[];
...
export class ExtraInformationCM {
...
export class ExtraInformationUM {
