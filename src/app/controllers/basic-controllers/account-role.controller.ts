...
export class AccountRoleController implements IAccountRoleController {
  constructor(
    protected readonly service: AccountRoleService,
  ...
  public findAll(): Promise<AccountRoleVM[]> {
  ...
  @ApiBadRequestResponse({ description: 'Have error in run time' })
  public findById(@Param('id') id: string): Promise<AccountRoleVM> {
  ...
  @ApiBadRequestResponse({ description: 'Have error in run time' })
  public insert(@Body() body: AccountRoleCM): Promise<AccountRoleVM> {
  ...
  @ApiBadRequestResponse({ description: 'Have error in run time' })
  public update(@Body() body: AccountRoleUM): Promise<AccountRoleVM> {
  ...
  @ApiBadRequestResponse({ description: 'Have error in run time' })
  public remove(id: string): Promise<AccountRoleVM> {
  ...
  @ApiBadRequestResponse({ description: 'Have error in run time' })
  public active(id: string): Promise<AccountRoleVM> {
  ...
  @ApiBadRequestResponse({ description: 'Have error in run time' })
  public deactive(id: string): Promise<AccountRoleVM> {
