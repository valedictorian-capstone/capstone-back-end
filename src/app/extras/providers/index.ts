import { EMPLOYEE_MODELS, BASIC_MODELS, BPMN_MODELS, CUSTOMER_MODELS, PRODUCT_MODELS } from '@models';
    ...
    return [
      {
        ...
        useFactory: async () => {
          ...
          const connection = createConnection({
            ...
            entities: [...BASIC_MODELS, ...BPMN_MODELS, ...CUSTOMER_MODELS, ...EMPLOYEE_MODELS, ...PRODUCT_MODELS],
            synchronize: true,
            logging: true,
