import { AccountRoleService } from './basic-services/account-role.service';
import { AccountService } from './basic-services/account.service';
import { RoleService } from './basic-services/role.service';

export const BASIC_SERVICES = [AccountRoleService, AccountService, RoleService];
export * from './basic-services/account-role.service';
...
export const BPMN_SERVICES = [WorkFlowService, WorkFlowConnectionService, WorkFlowInstanceService];
